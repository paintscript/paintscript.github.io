...
if((i < len)){
var k = (ks[i]);
var G__7976 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__7977 = (i + (1));
m = G__7976;
i = G__7977;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__7978 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__7978) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__7978));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__7980 = c;
var G__7980__$1 = (((G__7980 == null))?null:G__7980.prototype);
if((G__7980__$1 == null)){
return null;
} else {
return (G__7980__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__7982 = c;
var G__7982__$1 = (((G__7982 == null))?null:G__7982.prototype);
if((G__7982__$1 == null)){
return null;
} else {
return (G__7982__$1["render"]);
}
})() == null)))));
});
...
var G__7984 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__7984) : reagent.impl.component.as_element.call(null,G__7984));
};
...
while (G__7987__i < G__7987__a.length) {G__7987__a[G__7987__i] = arguments[G__7987__i + 0]; ++G__7987__i;}
  args = new cljs.core.IndexedSeq(G__7987__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__7990 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__7991 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__7991;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__7990;
}});
...
return ((function (G__7992,G__7992__$1){
...
var c = this;
var G__7997_7999 = (c["cljsRatom"]);
if((G__7997_7999 == null)){
} else {
reagent.ratom.dispose_BANG_(G__7997_7999);
}
...
var renders_8001 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_8002 = cljs.core.first(cljs.core.vals(renders_8001));
if((cljs.core.count(renders_8001) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_8001))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_8002)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_8002], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__8000 = name;
switch (G__8000) {
case "":
...
var G__8005 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__8005) : reagent.impl.component.global$module$create_react_class.call(null,G__8005));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__8006 = fiber;
var G__8006__$1 = (((G__8006 == null))?null:(G__8006["type"]));
if((G__8006__$1 == null)){
return null;
} else {
return (G__8006__$1["displayName"]);
}
})();
var parent = (function (){var G__8007 = fiber;
if((G__8007 == null)){
return null;
} else {
return (G__8007["return"]);
}
})();
var path = (function (){var G__8008 = parent;
var G__8008__$1 = (((G__8008 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__8008) : reagent.impl.component.fiber_component_path.call(null,G__8008)));
if((G__8008__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8008__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__8010 = c;
if((G__8010 == null)){
return null;
} else {
return (G__8010["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__8011._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__8013 = c;
if((G__8013 == null)){
return null;
} else {
return (G__8013["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__8015 = c;
if((G__8015 == null)){
return null;
} else {
return G__8015._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__8017 = instance;
if((G__8017 == null)){
return null;
} else {
return (G__8017["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__8018 = instance;
if((G__8018 == null)){
return null;
} else {
return G__8018._currentElement;
}
}
})();
var name = (function (){var G__8019 = elem;
var G__8019__$1 = (((G__8019 == null))?null:(G__8019["type"]));
if((G__8019__$1 == null)){
return null;
} else {
return (G__8019__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__8021 = elem;
if((G__8021 == null)){
return null;
} else {
return (G__8021["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__8022._owner;
}
}
})();
var path = (function (){var G__8023 = owner;
var G__8023__$1 = (((G__8023 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__8023) : reagent.impl.component.component_path.call(null,G__8023)));
if((G__8023__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8023__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__8024 = c;
var G__8024__$1 = (((G__8024 == null))?null:G__8024.constructor);
if((G__8024__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__8024__$1);
}
}
})();
