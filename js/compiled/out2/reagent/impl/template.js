...
var G__8044 = o;
(G__8044[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__8045__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__8045 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__8046__i = 0, G__8046__a = new Array(arguments.length -  0);
while (G__8046__i < G__8046__a.length) {G__8046__a[G__8046__i] = arguments[G__8046__i + 0]; ++G__8046__i;}
  args = new cljs.core.IndexedSeq(G__8046__a,0,null);
} 
return G__8045__delegate.call(this,args);};
G__8045.cljs$lang$maxFixedArity = 0;
G__8045.cljs$lang$applyTo = (function (arglist__8047){
var args = cljs.core.seq(arglist__8047);
return G__8045__delegate(args);
});
...
var G__8048 = o;
(G__8048[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__8050__i < G__8050__a.length) {G__8050__a[G__8050__i] = arguments[G__8050__i + 0]; ++G__8050__i;}
  args = new cljs.core.IndexedSeq(G__8050__a,0,null);
} 
...
var G__8053 = props;
var G__8053__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8053,cljs.core.cst$kw$id,id):G__8053);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8053__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__8054){
...
var props = map__8055__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8055__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__8055,map__8055__$1,props,class$){
return (function (c){
...
});})(map__8055,map__8055__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__8057){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8058__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__8058,map__8058__$1,on_write){
return (function (){
...
});})(node_value,map__8058,map__8058__$1,on_write))
);
} else {
...
var G__8061 = jsprops;
(G__8061["defaultValue"] = value);

(G__8061["onChange"] = ((function (G__8061,v,value,on_change){
return (function (p1__8060_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__8060_SHARP_);
});})(G__8061,v,value,on_change))
);
...
var vec__8064 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8064,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8064,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8064,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___8068 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___8068 == null)){
} else {
var key_8069 = temp__5724__auto___8068;
(jsprops["key"] = key_8069);
}
...
var temp__5724__auto___8070 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___8070 == null)){
} else {
var key_8071 = temp__5724__auto___8070;
reagent.impl.template.oset(jsprops,"key",key_8071);
}
...
var G__8072 = reagent.impl.template.__GT_NativeWrapper();
(G__8072["name"] = c);
...
var G__8073 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__8073) : reagent.impl.template.as_element.call(null,G__8073));
} else {
...
var len__4730__auto___8079 = arguments.length;
var i__4731__auto___8080 = (0);
while(true){
if((i__4731__auto___8080 < len__4730__auto___8079)){
args__4736__auto__.push((arguments[i__4731__auto___8080]));

var G__8081 = (i__4731__auto___8080 + (1));
i__4731__auto___8080 = G__8081;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq8077){
var G__8078 = cljs.core.first(seq8077);
var seq8077__$1 = cljs.core.next(seq8077);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8078,seq8077__$1);
});
...
var n__4607__auto___8086 = a.length;
var i_8087 = (0);
while(true){
if((i_8087 < n__4607__auto___8086)){
(a[i_8087] = reagent.impl.template.as_element((a[i_8087])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___8089 = a.length;
var i_8090 = (0);
while(true){
if((i_8090 < n__4607__auto___8089)){
var val_8091 = (a[i_8090]);
if(((cljs.core.vector_QMARK_(val_8091)) && ((reagent.impl.template.key_from_vec(val_8091) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_8090] = reagent.impl.template.as_element(val_8091));
...
var ctx = ({});
var vec__8093 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8093,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8093,(1),null);
...
var G__8096 = (cljs.core.count(argv) - first_child);
switch (G__8096) {
case (0):
...
var G__8097 = comp;
var G__8098 = jsprops;
var G__8099 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__8097,G__8098,G__8099) : reagent.impl.template.global$module$react.createElement.call(null,G__8097,G__8098,G__8099));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__8096){
